...
fcl.config({
  ...
  "app.detail.title": "Cat", // Change the title!
    ...
    try {
      const transactionId = await fcl.mutate({
        ...
        args: (arg, t) => [
          ...
          arg("Cat # "+_id.toString(), types.String),
          arg("Cat emojis on the blockchain", types.String),
          arg("ipfs://bafybeidgq2mpu4bhsymxvy37gm6vl53fze7gupf6sbphxeji4nvgkkvs4e/"+_id+".png", types.String),
        ],
